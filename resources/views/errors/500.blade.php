...
<body class="h-full bg-page antialiased">
    <div class="flex min-h-full items-center justify-center px-4 py-16">
        <div class="w-full max-w-md text-center">
            ...
            <div class="mx-auto mt-8 flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-50 text-rose-600">
                <x-icon name="cog" class="h-8 w-8" />
            </div>
            <h1 class="mt-6 text-6xl font-bold tracking-tight text-slate-900">500</h1>
            <p class="mt-3 text-lg font-semibold text-slate-900">Something went wrong</p>
            <p class="mt-1 text-sm text-slate-500">An unexpected error occurred. Please try again in a moment.</p>
